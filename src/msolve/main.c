...
static inline void display_help(char *str){
  ...
  display_option_help_noopt("0 - Interpret coefficients modulo the subfield characteristic. (default)\n");
  display_option_help_noopt("1 - Interpret coefficients as byte representations in the field extension.\n");
